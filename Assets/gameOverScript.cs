...
public class gameOverScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (GameData.level == "Level: Statique")
        {
            ...
            if (GameData.totalScore > GameData.bestScoreStat) GameData.bestScoreStat = GameData.totalScore;
        ...
        else if (GameData.level == "Level: Mobile")
        {
            ...
            if (GameData.totalScore > GameData.bestScoreMob) GameData.bestScoreMob = GameData.totalScore;
            windspeedText.SetText("Game Over \n Your score in " + GameData.level + " is " + GameData.totalScore + "\nNew High Score");
        }
        else if (GameData.level == "Level: Marathon")
        {
            highScore = GameData.bestScoreMar;
            if (GameData.totalScore > GameData.bestScoreMar) GameData.bestScoreMar = GameData.totalScore;
            windspeedText.SetText("Game Over \n Your score in " + GameData.level + " is " + GameData.totalScore + "\nNew High Score");
        }
        else if (GameData.level == "Level: Hunt")
        {
            highScore = GameData.bestScoreHunt;
            if (GameData.totalScore > GameData.bestScoreHunt) GameData.bestScoreHunt = GameData.totalScore;
            windspeedText.SetText("Game Over \n Your score in " + GameData.level + " is " + GameData.totalScore + "\nNew High Score");
        }
        else windspeedText.SetText("Game Over \n Your score in "+ GameData.level +" is " + GameData.totalScore+"\nYour High score is " + highScore);
